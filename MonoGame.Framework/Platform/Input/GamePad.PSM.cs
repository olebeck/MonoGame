...
﻿namespace Microsoft.Xna.Framework.Input
{
    static partial class GamePad
    {
        ...
        private static GamePadState PlatformGetState(int index, GamePadDeadZone leftDeadZoneMode, GamePadDeadZone rightDeadZoneMode)
        {
            ...
            var state = new GamePadState(new GamePadThumbSticks(leftStick, rightStick, leftDeadZoneMode, rightDeadZoneMode), new GamePadTriggers(), new GamePadButtons((Buttons)buttons), new GamePadDPad((Buttons)buttons));
